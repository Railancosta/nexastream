...
const pt: Dict = {
  ...
  justNow: 'agora', yesterday: 'ontem', daysAgo: 'd', monthsAgo: 'mês', monthsAgoP: 'meses', studio: 'Studio',
...
const en: Dict = {
  ...
  justNow: 'now', yesterday: 'yesterday', daysAgo: 'd', monthsAgo: 'month', monthsAgoP: 'months', studio: 'Studio',
...
const es: Dict = {
  ...
  installApp: 'Instalar app', language: 'Idioma', hoursAgo: 'h', minutesAgo: 'min',
  justNow: 'ahora', yesterday: 'ayer', daysAgo: 'd', monthsAgo: 'mes', monthsAgoP: 'meses', studio: 'Studio',
